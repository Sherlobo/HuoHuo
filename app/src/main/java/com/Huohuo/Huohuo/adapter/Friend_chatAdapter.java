...
public class Friend_chatAdapter extends RecyclerView.Adapter <Friend_chatAdapter.ViewHolder> implements View.OnClickListener {
    private List<FriendChat> mFriend_chatList;

    private OnRecyclerViewItemClickListener mOnItemClickListener = null;

    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, FriendChat friend_chat);
    }

    public Friend_chatAdapter(List<FriendChat> friend_chatList){
    ...
    public void onBindViewHolder(Friend_chatAdapter.ViewHolder holder, int position) {
        FriendChat mFriend_chat=mFriend_chatList.get(position);
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            mOnItemClickListener.onItemClick(view, (FriendChat) view.getTag());
        }
    }
